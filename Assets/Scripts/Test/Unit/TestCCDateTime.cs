...
namespace Test.Unit
{
    public class TestCCDateTime
    {
        ...
        {
            var dateTime = new DateTime(2025, 6, 24, 15, 30, 0);
        ...
        {
            var earlier = new CCDateTime(new DateTime(2025, 6, 24, 15, 30, 0));
            var later = new CCDateTime(new DateTime(2025, 6, 24, 15, 31, 0));
